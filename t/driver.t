...
BEGIN {
    ...
    use_ok $CLASS or die;
    use_ok 'DBIx::Connector::Pg' or die;
...
ok my $conn = DBIx::Connector::Pg->new('dbi:ExampleP:dummy', '', ''), 'Construct example connection';
is $conn->driver, $dr, 'It should have the driver';

ok $conn = DBIx::Connector::Pg->new('dbi:Pg:dbname=try', '', ''), 'Construct a Pg connection';
